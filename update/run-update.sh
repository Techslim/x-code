...
version=$(cat /home/ver)
new_version=$( curl https://raw.githubusercontent.com/${GitUser}/versionxray/main/version.conf | grep $version )
#Status Version
...
wget -O bannermenu "https://raw.githubusercontent.com/${GitUser}/x-code/main/update/bannermenu.sh"
