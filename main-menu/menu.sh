...
echo -e "  \e[$text Isp Name             : $ISP"
echo -e "  \e[$text City                 : $CITY"
echo -e "  \e[$text Time                 : $WKT"
echo -e "  \e[$text Ip Vps               : $IPVPS"
echo -e "  \e[$text Domain               : $domain\e[0m"
echo -e "  \e[$text Script Version       : Techslim(V1)"
...
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   "  \e[$number (•1)\e[m \e[$below PANEL VMESS & VLESS\e[m        \e[$number (•7)\e[m \e[$below MENU THEMES\e[m"
echo -e   "  \e[$number (•2)\e[m \e[$below PANEL TROJAN\e[m               \e[$number (•8)\e[m \e[$below CLEAR LOG VPS\e[m"
echo -e   "  \e[$number (•3)\e[m \e[$below PANEL WIREGUARDS\e[m           \e[$number (•9)\e[m \e[$below CHANGE PORT VPN\e[m"
echo -e   "  \e[$number (•4)\e[m \e[$below PANEL SS & SSR\e[m             \e[$number (10)\e[m \e[$below CHECK RUNNING SC\e[m"
echo -e   "  \e[$number (•5)\e[m \e[$below PANEL SSH & OPENVPN\e[m        \e[$number (11)\e[m \e[$below REBOOT VPS\e[m"
echo -e   "  \e[$number (•6)\e[m \e[$below SYSTEM MENU\e[m                \e[$number (12)\e[m \e[$below EXIT MENU\e[m"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   "  \e[$below Premium VPS by $creditt"
echo -e   "  \e[$below Thank you for using script by Techslim"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   ""
