...
echo -e   "  \e[$line═══════════════════════════════════════════════════════\e[m"
echo -e   "  \e[$back_text          \e[30m[\e[$box CREATE USER XRAY TROJAN GRPC TLS\e[30m ]\e[1m         \e[m"
echo -e   "  \e[$line═══════════════════════════════════════════════════════\e[m"
...
},{"id": "'""$uuid""'","password": "'""$user""'","email": "'""$user""'"' /usr/local/etc/xray/trojangrpc.json
...
clear
echo -e ""
echo -e "\e[$line═════[Xray Trojan TCP Grpc]══════\e[m"
echo -e "Remarks         : ${user}"
