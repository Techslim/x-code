...
echo -e "Auto-Reboot has been successfully set Every 00]00 a]m]"
echo -e "\e[0;32mDone\e[0m"
}
...
echo -e "Auto-Reboot has been successfully set Every 02]00 a]m]"
echo -e "\e[0;32mDone\e[0m"
}
...
echo -e "Auto-Reboot has been successfully set Every 04]00 a]m]"
echo -e "\e[0;32mDone\e[0m"
}
function stop () {
rm -f /etc/cron.d/reboot
...
echo -e "     \e[0;36m[•7]\e[0m Set Auto-Reboot Every 00]00 A]M"
echo -e "     \e[0;36m[•8]\e[0m Set Auto-Reboot Every 2]00 A]M"
echo -e "     \e[0;36m[•9]\e[0m Set Auto-Reboot Every 4]00 A]M"
