...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/x-code/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
#install ssr
echo -e "\e[0;32mINSTALLING SS & SSR...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/x-code/main/install/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget https://raw.githubusercontent.com/${GitUser}/x-code/main/install/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
echo -e "\e[0;32mDONE INSTALLING SS & SSR\e[0m"
#installwg
echo -e "\e[0;32mINSTALLING WIREGUARD...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/x-code/main/install/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
echo -e "\e[0;32mDONE INSTALLING WIREGUARD\e[0m"
#install Xray
echo -e "\e[0;32mINSTALLING XRAY CORE...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/x-code/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
echo -e "\e[0;32mDONE INSTALLING XRAY CORE\e[0m"
#install Set-BR
echo -e "\e[0;32mINSTALLING Set-Br...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/x-code/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
echo -e "\e[0;32mDONE INSTALLING Set-Br...\e[0m"
#install ohp-server
echo -e "\e[0;32mINSTALLING OHP PORT...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/x-code/main/install/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/${GitUser}/x-code/main/install/ohp-dropbear.sh && chmod +x ohp-dropbear.sh && ./ohp-dropbear.sh
wget https://raw.githubusercontent.com/${GitUser}/x-code/main/install/ohp-ssh.sh && chmod +x ohp-ssh.sh && ./ohp-ssh.sh
echo -e "\e[0;32mDONE INSTALLING OHP PORT\e[0m"
#install websocket
echo -e "\e[0;32mINSTALLING WEBSOCKET PORT...\e[0m"
wget https://raw.githubusercontent.com/${GitUser}/x-code/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
...
# Version
ver=$( curl https://raw.githubusercontent.com/${GitUser}/versionxray/main/version.conf )
history -c
echo "$ver" > /home/ver
clear
echo " "
...
echo ""  | tee -a log-install.txt
echo "    [INFORMASI WIREGUARD]"  | tee -a log-install.txt
echo "    ---------------------" | tee -a log-install.txt
...
echo "   - XRAY Vmess WS None TLS  : 89"  | tee -a log-install.txt
echo "   - XRAY Vless WS TLS       : 8443"  | tee -a log-install.txt
echo "   - XRAY Vless WS None TLS  : 8880"  | tee -a log-install.txt
echo "   - XRAY Vless Xtls DIRECT  : 9443"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "   - Dev/Main                : SCRIPT BY TECHSLIM"  | tee -a log-install.txt
echo "-------------------------Script By Techslim-----------------------" | tee -a log-install.txt
echo ""
echo -e "	 \e[1;31mYour VPS Will Be Automatical Reboot In 5 s\e[0m"
rm -r setup.sh
sleep 5
reboot
