...
vlesslink1="vless://${uuid}@${domain}:$tls?path=$patch&security=tls&encryption=none&type=ws&sni=bug.com#${user}"
vlesslink2="vless://${uuid}@${domain}:$none?path=$patch&encryption=none&host=bug.com&type=ws#${user}"
clear
echo -e ""
